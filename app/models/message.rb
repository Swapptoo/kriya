      ...
      if self.freelancer && self.freelancer.stripe_client_id.blank?
        ...
        if self.user.present?
          if self.msg_type == 'bot-half-charge-task'
            self.update(body: "Awesome! Thank you for the detailed description of the task. Please pay 50% of the budget, $#{amount} to continue. This goes into Kriya Escrow and will be paid to the workforce ONLY after successful completion of the task. We revert the charge otherwise.")
          else
